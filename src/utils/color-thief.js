...
//     image.src = `data:image/png;base64,${Buffer.from(src).toString('base64')}`
 ...
 *
 * */
ColorThief.prototype.getColor = function (src, quality) {
    const sourceImage = new Image(500, 500)
    sourceImage.src = `data:image/png;base64,${Buffer.from(src).toString('base64')}`
